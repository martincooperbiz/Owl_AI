...
def filter_on_date(df, start, end, date_col="DATE"):
    ...
    df = df[(df[date_col].notnull()) & (df[date_col].dt.date >= start_date) & (df[date_col].dt.date <= end_date)]
